...
@section('content')
    <div class="main-content">
        ...
        <p>Pour toute question d'ordre pédagogique, vous pouvez contacter par e-mail <a href="mailto:aurelien.moreau@enssat.fr"><span class="important">Aurélien MOREAU</span> (aurelien.moreau@enssat.fr)</a> et/ou <a href="mailto:claire.le-page@enssat.fr"><span class="important">Claire LE PAGE</span> (claire.le-page@enssat.fr)</a>.</p>
        <p class="important">Ils sont les contacts privilégiés sur les sujets suivants :</p>
        <ul class="default-style">
