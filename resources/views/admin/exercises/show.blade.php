...
@section('content')
    ...
    <div class="main-content">
        ...
        <div class="part-container">
            ...
            <div class="table" id="exercise-questions">
                        ...
                        <tr>
                            <th scope="col">
                                <button class="sort" data-sort="number">
                                    {{ __('common.number') }} <i class="fas fa-arrows-alt-v"></i>
                                </button>
                            </th>
                            ...
                            <th scope="col">
                                <button class="sort" data-sort="difficulty">
                                    {{ __('statistics.difficulty_rate') }} <i class="fas fa-arrows-alt-v"></i>
                                </button>
                            </th>
